...
from utils import preprocessors1, arglist
...
class A2CNet(nn.Module):
    def __init__(self):
        ...
        self.player_specs = preprocessors1.FLAT_FEATURES
    ...
    @staticmethod
    def make_one_hot_1d(labels, num_classes, use_gpu):
        """..."""
        desired_shape = (labels.size(0), num_classes)
        labels = labels.contiguous().view(-1, 1)
        target = torch.zeros(*desired_shape, requires_grad=False)
    ...
    @staticmethod
    def make_one_hot_3d(labels, num_classes, use_gpu):
        """..."""
